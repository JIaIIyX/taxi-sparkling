                ...
                <table class="cart_table">
                    ...
                    <tbody>
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-detailis.html"> Engine Plug</a>
                            </td>
                            <td data-title="Price">
                        ...
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-detailis.html">Air Filter</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            ...
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-detailis.html">CSK Red Wheel</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
